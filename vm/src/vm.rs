...
pub struct VirtualMachine {
    ...
    pub import_callback: Option<Box<dyn Fn(ast::Program, &str) -> ast::Program>>,
}
...
impl VirtualMachine {
    ...
    pub fn new_with_callback<'a>(settings: PySettings, import_callback: Box<dyn Fn(ast::Program, &str) -> ast::Program>) -> VirtualMachine {
